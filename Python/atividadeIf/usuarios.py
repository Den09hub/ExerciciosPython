...
if opcao == 1: 
    ...
    if (usuario == usuario1_nome and int(senha == usuario1_senha)) or (usuario == usuario2_nome and int(senha == usuario2_senha)) or (usuario == usuario3_nome and int(senha == usuario3_senha)):
...
if consumo_por_pessoa_por_dia > 200:
        ...
        if consumo_por_pessoa_por_dia < 100:
